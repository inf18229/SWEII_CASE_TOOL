...
public class C_frame implements I_C_frame{
    ...
    /**
     * changes the currentController depending on the variable newTab
    ...
    public void notifyTabChange(int newTab) {
        switch (newTab){
            case 0:
                ...
                break;
            case 1:
                //TODO: add when ready currentController = controllerTab1(XXX);
                System.out.println("Tab: 1");
                break;
            case 2:
                //TODO: add when ready currentController = controllerTab2(XXX);
